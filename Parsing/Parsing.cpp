...
/*size_t got_data(char *buffer, size_t itemsize, size_t nitems, std::string * data){
...
std::string request() {
  ...
  std::string result;
  std::string url = "https://world-weather.ru/pogoda/russia/krasnoyarsk/14days/";
...
void split(Gumbo *node, std::vector<std::string> &res){
	GumboVector *children = &node->v.element.children;
